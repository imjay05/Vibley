      ...
      {imagePreview && (
        <div className="mb-2 relative inline-block">
          ...
          <button onClick={clearImage}
            className="absolute -top-1.5 -right-1.5 size-5 bg-gray-700 text-white 
                      rounded-full flex items-center justify-center hover:bg-gray-900 transition-colors">
            <X className="size-3" />
          </button>
        </div>
      )}
      ...
      <form onSubmit={handleSend} className="flex items-center gap-2">
        ...
        <input
          ...
          className="flex-1 bg-gray-100 rounded-xl px-4 py-2.5 text-sm outline-none 
                     focus:bg-gray-50 transition-colors placeholder:text-gray-400"
        ...
        <button 
          ...
          className="size-10 bg-blue-600 hover:bg-blue-700 disabled:opacity-40 
                    disabled:cursor-not-allowed rounded-xl flex items-center justify-center transition-colors flex-shrink-0">
