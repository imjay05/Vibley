    ...
    <div className="p-4 space-y-4">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 py-2.5 border border-gray-200 
                     hover:bg-gray-50 disabled:opacity-40 rounded-xl text-sm text-gray-600 transition-colors">
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-purple-600 
                     hover:bg-purple-700 disabled:opacity-40 text-white rounded-xl text-sm font-medium transition-colors">
          {isPosting ? (
